...
def search_assessment_files_for_full_license():
    licenses = load_licenses([Config.licenses_dir])
    ...
    for file_data in Config.file_data_manager.get_all_file_data():
        ...
        license_matches = []
        for license_path, license_text in licenses.items():
...
if __name__ == "__main__":
    search_assessment_files_for_full_license()